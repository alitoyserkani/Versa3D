...
QGLFormat Canvas::formatGL() { // added to remove formatting created in window class
    QGLFormat format;
...
void Canvas::initializeGL()
{
    ...
    mesh_shader.addShaderFromSourceFile(QGLShader::Vertex, ":/gl/gl/mesh.vert");
    mesh_shader.addShaderFromSourceFile(QGLShader::Fragment, ":/gl/gl/mesh.frag");
    mesh_shader.link();
...
void Canvas::paintEvent(QPaintEvent *event)
{
    ...
    //TODO: Build shaders for build space

    // If a mesh has been inserted (mesh is not null)
    if (mesh)  draw_mesh();
...
void Canvas::draw_mesh()
{
    ...
    //Embed trandform matrix into shader programs
    glUniformMatrix4fv(
