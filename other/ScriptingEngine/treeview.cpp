...
//! [4]
TreeItem *TreeView::getItem(const QModelIndex &index) const
{
    if (index.isValid()) {
...
bool TreeView::insertColumns(int position, int columns, const QModelIndex &parent)
{
    bool success;
...
bool TreeView::insertRows(int position, int rows, const QModelIndex &parent)
{
    TreeItem *parentItem = getItem(parent);
    bool success;
...
bool TreeView::removeColumns(int position, int columns, const QModelIndex &parent)
{
    bool success;
...
bool TreeView::removeRows(int position, int rows, const QModelIndex &parent)
{
    TreeItem *parentItem = getItem(parent);
    bool success = true;
...
bool TreeView::setHeaderData(int section, Qt::Orientation orientation,
...
void TreeView::setupModelData(const QStringList &lines, TreeItem *parent)
{
